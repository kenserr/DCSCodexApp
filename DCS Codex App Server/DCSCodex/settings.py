...
Code History: 
1/30 - Set TIME_ZONE, DCSCodexAdmin to INSTALLED_APPS
1/31 - 'rest_framework' and 'rest_framework.authtoken' to INSTALLED_APPS
...
SECRET_KEY = '@cq=bkt)l%)%61pd=^6(ku7t^ipmi9gp7k-!&wu#&l%nq=4q04'
...
WSGI_APPLICATION = 'DCSCodex.wsgi.application'
...
# For abstract user authentication 
AUTH_USER_MODEL = 'DCSCodexAdmin.User'
